...
- To use an OpenAI-compatible API, set `LLM_PROVIDER=openai` and provide `OPENAI_API_KEY`; optionally set `BRAIN_MODEL` and `OPENAI_BASE_URL` (defaults to `qwen2.5:7b` via local Ollama).
