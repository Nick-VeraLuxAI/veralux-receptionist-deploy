...
This document describes how the voice runtime reads Redis data published by the control plane. It is intentionally precise and used by tooling, but the first sections are readable for non-developers.
