...
const DEESSER_ENABLED = false; // disabled — was stripping crispness in 5.5–8 kHz band
const LOWPASS_16K_CUTOFF_HZ = 7900;
const LOWPASS_8K_CUTOFF_HZ = 3400;
const LIMITER_THRESHOLD = 0.96;
const RMS_TARGET = 0.20;
...
function processTelephonyTTSInternal(
  ...
  const appliedDeEsser = DEESSER_ENABLED && inputSampleRate >= DEESSER_HIGH_HZ * 2;
